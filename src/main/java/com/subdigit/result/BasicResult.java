...
//		if(!_initialized) throw InvalidServiceException();
	...
	public boolean hasData(String key){ return (key == null)?false:(dataStore.containsKey(key))?false:true; }
	...
	public boolean hasMessage(){ return (getRecentStatusMessage() == null)?false:true; }
	...
	public boolean hasException(){ return (getRecentStatusException() == null)?false:true; }
	...
	public boolean hasLevel(){ return (getRecentStatusMessage() == null)?false:true; }
